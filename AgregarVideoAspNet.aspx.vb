...
Partial Class AgregarVideoAspNet
    ...
    Protected Sub cargarVideo()
        Dim youtubeUrl As String = "https://www.youtube.com/watch?v=MZtB7pQFAV4"
        ...
        Dim sHtml As String = "<object width='{0}' height='{1}' " & _
            "data='http://www.youtube.com/v/{2}&autoplay=0' codetype='application/x-shockwave-flash'>" & _
